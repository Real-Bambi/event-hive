                ...
                <div className='flex flex-row justify-between pb-[100px]'>
                    <div className=' '>
                        ...
                        <div className='flex flex-col w-[600px] h-[397px] pl-[60px] pt-[60px] gap-5'>
                            <h2 className='text-white font-bold text-big-heading'>Dream world wide in jakatra</h2>
                            <h3 className='text-white font-bold text-heading'>IIIT Sonepat</h3>
                            <p className='text-sm text-white '>DesignHub organized a 3D Modeling Workshop using Blender on 16th February at 5 PM. The workshop taught participants the magic of creating stunning 3D models and animations using Blender. It was suitable for both beginners and experienced users. The event was followed by a blender-render competition, which added to the excitement.</p>
            ...
            <div className='flex flex-row justify-between'>
                ...
                <div className='w-[600px] flex flex-col gap-5 pt-10 pl-20'>
                    <div>
                        ...
                        <p>
                            ...
                            DesignHub organized a 3D Modeling Workshop using Blender on 16th February at 5 PM. The workshop taught participants the magic of creating stunning 3D models and animations using Blender.</p>
                    </div>
                    <div>
                        <h2>Hours</h2>
                        <span>Weekdays hour: 7PM - 10PM</span>
                        <span> Sunday hour:  7PM - 10PM</span>
                    </div>
                    <div>
                        <h2>Organizer Contact</h2>
                        <Link>Please go to www.sneakypeeks.com and refer the FAQ section for more detail</Link>
                    </div>
                ...
                <div className='flex flex-col gap-5'>
                    <div>
                        ...
                        <p>This is the location of GCTU capus, Accra, Tesano.</p>
                    </div>
                    <div>
                        <h2>Tags</h2>
                        <p>
                    ...
                    <div className='flex'>
                        ...
                        <img src="./assets/images/facebook.png" alt="facebook" srcset="" />
                        <img src="./assets/images/twitter.png" alt="twitter" srcset="" />
                        <img src="./assets/images/linkedin.png" alt="linkedin" srcset="" />
                        <img src="./assets/images/youtube.png" alt="youtube" srcset="" />
                    </div>
