        ...
        <div className=" mx-auto mt-[80px] h-screen flex flex-col md:flex-row justify-around">
            ...
            <div className="w-3/5 items-center justify-center bg-bgGrey">
             ...
             <div className='flex flex-col items-center'>
              ...
              <button className=' pt-2 border w-[70%] rounded bg-white py-2 px-20 gap-4'> <img src={GoogleImage} alt="google icon"  className='w-5 h-5 align-middle inline-block'/> Sign Up with  Google</button>
