  ...
  export default function Login() {
    return (
        ...
        <form className='flex flex-col pt-16 w-[80%] mx-auto '>
            <div className='flex flex-col pt-2 '>
                <label htmlFor="your name" className='p-2 font-medium'>YOUR EMAIL</label>
            <input type="text" name="name" id="name" placeholder="Enter your mail" className='w-[100%] px-6 py-2 bg-white ' />
            </div>
            ...
            <div className='flex flex-col items-center justify-center pt-10 '>
                <button className='text-white bg-primary w-48 px-6 py-2  rounded  '>Sign In</button>
